...
###############################
    ...
    def set_ownbirddata(self, birdid, lat, lon, hdg):
        self.data.ownbirdid  = birdid
        self.data.ownbirdlat = lat
        self.data.ownbirdlon = lon
        self.data.ownbirdhdg = hdg
#############################
...
class ND(QGLWidget):
    ...
    def setBirdID(self, bird_id):
        self.bird_id = bird_id
        self.setWindowTitle(bird_id)
...
#############################        
        # tas required???
    def update_bird_data(self, ownbirdid, ownbirdlat, ownbirdlon, ownbirdtas, ownbirdhdg, n_birds):
        print "updating birdies"
        self.globaldata.set_ownbirddata(ownbirdid, ownbirdlat, ownbirdlon, ownbirdhdg)
